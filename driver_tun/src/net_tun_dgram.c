...
int net_tun_dgram_init(net_dgram_t base_dgram) {
    ...
    /*         CPE_ERROR(em, "raw: dgyam: not support domain address!"); */
    /*         return -1; */
    /*     } */
    /* } */
    /* else { */
    ...
    /* if (dgram->m_fd == -1) { */
    /*     CPE_ERROR( */
    /*         em, "raw: dgram: socket create error, errno=%d (%s)", */
    ...
    /*         CPE_ERROR(em, "raw: dgram: sock process fail"); */
    ...
    /*         CPE_ERROR(em, "raw: dgram: get sockaddr from address fail"); */
    /*         cpe_sock_close(dgram->m_fd); */
    /*         return -1; */
    /*     } */
    ...
    /*         CPE_ERROR( */
    /*             em, "raw: dgram: bind addr fail, errno=%d (%s)", */
    /*             cpe_sock_errno(), cpe_sock_errstr(cpe_sock_errno())); */
    /*         cpe_sock_close(dgram->m_fd); */
    /*         dgram->m_fd = -1; */
    /*         return -1; */
    ...
    /*         CPE_ERROR( */
    /*             em, "raw: dgram: sockaddr error, errno=%d (%s)", */
    /*             cpe_sock_errno(), cpe_sock_errstr(cpe_sock_errno())); */
    /*         cpe_sock_close(dgram->m_fd); */
    /*         dgram->m_fd = -1; */
    /*         return -1; */
    ...
    /*     if (address == NULL) { */
    /*         CPE_ERROR(net_schedule_em(schedule), "raw: dgram: create address fail"); */
    /*         cpe_sock_close(dgram->m_fd); */
    /*         dgram->m_fd = -1; */
    /*         return -1; */
    /*     } */
